...
const amenities = [
  ...
  { icon: "bi-temple", label: "Temple Tour" },
  { icon: "bi-mountain", label: "Girivalam Trip" },
  { icon: "bi-train-light", label: "Railway Station Pickup" },
  { icon: "bi-airplane", label: "Airport Transfer" },
  { icon: "bi-person-hearts", label: "Family Tour Packages" },
];
